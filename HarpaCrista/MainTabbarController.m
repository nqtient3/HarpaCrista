...
- (void)viewDidLoad {
    ...
    tabBarHinosItem.selectedImage = [UIImage imageNamed:@"ic_hinos"];
    UITabBarItem *tabBarFavoritosItem = [self.tabBar.items objectAtIndex:1];
    tabBarFavoritosItem.selectedImage = [UIImage imageNamed:@"ic_star"];
    UITabBarItem *tabBarMaisItem = [self.tabBar.items objectAtIndex:2];
    tabBarMaisItem.selectedImage = [UIImage imageNamed:@"ic_global"];
}
